...
import sys
sys.path.append('/home/seba/opendrift/')
...
from opendrift.models.larvalocoV1 import LarvaLoco

o = LarvaLoco(loglevel=0)
...
o.seed_elements(lon=-71.5, lat=-29.8, time=time)
