...
print(mosa_native)  
start_date = mosa_native.start_time  + timedelta(days=149) # 5 agosto 2000
#end_date = mosa_native.end_time

#outname='fig_30part_ene'
#particulas_total=10000
dias_deriva = 6 # PLD lapa
...
np.savetxt('Part_Coq_lapa_ago.txt', all, fmt='%s %.4f %.4f %s %.4f %.4f %i')
print(o)
